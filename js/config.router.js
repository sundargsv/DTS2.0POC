          ...
          $stateProvider
              ...
              .state('app.customer', {
                  ...
                  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load(['js/controllers/custom/customer.js'
                          , 'js/services/custom/customerService.js']);
                      }]
                  }
              })
              .state('app.customer.search', {
                  url: '/search',
                  templateUrl: 'menuItems/customer/search.html',
              ...
              .state('app.customer.view', {
                  url: '/view',
                  templateUrl: 'menuItems/customer/view.html',
                  params : { item: null, },
              ...
              .state('app.customer.create', {
                  url: '/create',
                  templateUrl: 'menuItems/customer/create.html',
